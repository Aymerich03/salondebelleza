<div class="content-mid-top">
	<h3>Servicios para el cabello</h3>
</div>
<div class="container">
<?php if(count($hr)> 0): ?>

<?php foreach ($hr as $hair): ?>
<div class="popular" id="services">
    <h3> <?php echo $hair['Service']['name']; ?></h3>
    <div class="container">
        <div class="col-md-8 popular-grid">
            <h4><a href="#">Descripción</a></h4>
            <p>
                <?php echo $hair[ 'Service'][ 'description']; ?>
            </p>
        </div>
        <div class="col-md-4 popular-grid">
            <h4><a href="#">Precio</a></h4>
            <p>
                <?php echo $hair[ 'Service'][ 'price']; ?>
            </p>
        </div>
...
<div class="gallery" id="gallery" style= "margin-bottom: 30px">
    <div class="gallery-top">
        ...
        <?php if($image['Image']['category'] == $hair['Service']['id'] ): ?>
