        ...
        <div class="container">
            ...
            <div class="welcome">
                ...
                <div class="col-md-8 col">
                    ...
                    <div class="col2">
                        <div class="col-md-6 col1">
                            <figure class="effect-bubba">
                                <img class="img-responsive" src="images/we2.jpg" alt="" />
                                <figcaption>
                                    <h4>Enimet pulvinar posuere</h4>
                                    <p>In sit amet sapien eros Integer dolore magna aliqua</p>
                                </figcaption>
                        ...
                        <div class="col-md-6 col1">
                            <figure class="effect-bubba">
                                <img class="img-responsive" src="images/we3.jpg" alt="" />
                                <figcaption>
                                    <h4>Enimet pulvinar posuere</h4>
                                    <p>In sit amet sapien eros Integer dolore magna aliqua</p>
                                </figcaption>
                    ...
                    <div class="col-md-6 new-more-at">
                        <div class=" new-more-at1">
                            ...
                            <div class="col-md-9 about1">
                                ...
                                <p>Kasertas lertyasea deeraeser miasera lertasa ritise doloert ferdas caplicabo nerafaes asety u lasec vaserat. nikertyade asetkertyptaiades asety u lasec vaserat. nikertyade asetkertyptaiades</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
            ...
            <div class="test">
                ...
                <div class="col-md-5 test1">
                    <img class="img-responsive" src="images/me1.png" alt="">
                </div>
                <div class="col-md-7 test2">
                    <h5>Ailsa</h5>
            ...
            <div class="container">
                <div class="content-bottom-top">
                    <div class="col-md-6 content-bottom-top1">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                            specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
                            passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin
                ...
                <div class="col-md-4 col1 gallery-grid">
                    <a href="images/ga.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        ...
                        <figure class="effect-bubba">
                            ...
                            <figcaption>
                                <h4 class="gal">Enimet pulvinar posuere</h4>
