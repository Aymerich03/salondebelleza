<div class="popular" id="services">
    <h3>Servicios para tus uñas</h3>
    <div class="container">
        <?php if(count($nails)> 0): ?>
        <?php foreach ($nails as $nail): ?>
        <div class="popular" id="services">
            <h3> <?php echo $nail['Service']['name']; ?></h3>
            <div class="container">
                <div class="col-md-4 popular-grid">
                    <h4><a href="#">Descripción</a></h4>
                    <p>
                        <?php echo $nail[ 'Service'][ 'description']; ?>
                    </p>
                </div>
        ...
        <div class="gallery" id="gallery" style="margin-bottom: 30px">
            <div class="gallery-top">
                ...
                <?php if($image[ 'Image'][ 'category']== $nail[ 'Service'][ 'id'] ): ?>
